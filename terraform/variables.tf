...
variable "landing_schemas_available_to_loader" {
  type = set(string)
  default = ["\"LANDING\".\"RAINTREE\"", "\"LANDING\".\"ADAPTIVE\""]
  # default = ["LANDING.ADAPTIVE","LANDING.CLINIC_MASTER","LANDING.FIVETRAN_COSTUME_SYMPHYSIS_STAGING","LANDING.FIVETRAN_METADATA","LANDING.FIVETRAN_OFT_EFFICIENCY_STAGING","LANDING.FOTO","LANDING.INFORMATION_SCHEMA","LANDING.LOCATIONS_MASTER_DATA_TEST","LANDING.OBJECTIVES_TRACKING","LANDING.PUBLIC","LANDING.RAINTREE","LANDING.RINGCENTRAL","LANDING.SALESFORCE","LANDING.TESTGRANTSCHEMA"]
}
